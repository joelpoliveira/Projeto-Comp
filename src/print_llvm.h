...
char * llvm_expression_or_list(is_expression_or_list* ieol, id_token* aux, int);
char * llvm_expression_and_list(is_expression_and_list* ieal, id_token* aux, int);
char * llvm_expression_comp_list(is_expression_comp_list * iecl, id_token* aux, int);
