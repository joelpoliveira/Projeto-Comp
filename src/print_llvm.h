...
int llvm_statement( is_statement* is,table_element**, int);
int llvm_if_statement(is_if_statement* ifs,table_element**, int);
int llvm_else_statement(is_else_statement* ies,table_element**, int);
...
int llvm_statements_list(is_statements_list* isl,table_element**, int);
